    ...
    <footer className="flex flex-col w-full items-start p-6 md:p-10 lg:p-14 relative bg-[#336699] rounded-2xl md:rounded-[32px]">
      ...
      <div className="flex flex-col lg:flex-row items-start justify-center gap-8 lg:gap-5 pt-0 pb-10 md:pb-[60px] px-0 relative self-stretch w-full flex-[0_0_auto]">
        ...
        <nav className="flex flex-col items-start gap-6 lg:gap-11 relative flex-1 self-stretch w-full lg:grow">
          <h3 className="self-stretch mt-[-1.00px] font-normal text-white text-xl md:text-2xl lg:text-[30.4px] tracking-[0] leading-6 md:leading-8">
            {t.footer.sections}
          </h3>
            ...
            {sectionsLinks.map((link, index) => (
              ...
              >
                <span className="flex items-start px-0 py-[3.5px] relative self-stretch w-full flex-[0_0_auto] cursor-default">
                  <span className="flex-1 mt-[-1.00px] font-extralight text-white text-base md:text-lg lg:text-xl tracking-[0] leading-5">
                    {link}
                  </span>
                </span>
              </li>
        ...
        <nav className="flex flex-col items-start gap-6 lg:gap-11 relative flex-1 self-stretch w-full lg:grow">
          <h3 className="self-stretch mt-[-1.00px] font-normal text-white text-xl md:text-2xl lg:text-[30.5px] tracking-[0] leading-6 md:leading-8">
            {t.footer.patients}
          </h3>
        ...
        <div className="flex flex-col items-start gap-8 lg:gap-12 relative flex-1 self-stretch w-full lg:grow">
          <h3 className="self-stretch mt-[-1.00px] font-normal text-white text-xl md:text-2xl lg:text-[29.8px] tracking-[0] leading-6 md:leading-8">
            {t.footer.contacts}
          </h3>
          ...
          <div className="flex flex-col items-start gap-6 lg:gap-10 relative self-stretch w-full flex-[0_0_auto]">
            <address className="flex flex-col items-start gap-3 relative self-stretch w-full flex-[0_0_auto] not-italic">
              <span className=" font-extralight text-[#ffffffcc] text-sm md:text-base tracking-[0] leading-4 self-stretch mt-[-1.00px]">
                {t.footer.addressLabel}
              </span>

              <p className="self-stretch mt-[-1.00px] font-extralight text-white text-base md:text-lg lg:text-xl tracking-[0] leading-5">
                {t.header.address}
              </p>
            </address>
            ...
            <div className="flex flex-col items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
              ...
              >
                <span className="flex-1 text-white text-base md:text-lg lg:text-xl leading-5 mt-[-1.00px] font-extralight tracking-[0]">
                  {t.header.phone}
                </span>
              </a>

              <p className=" font-extralight text-[#ffffffcc] text-sm md:text-base tracking-[0] leading-4 self-stretch mt-[-1.00px] pt-px">
                {t.footer.schedule}
              </p>
            </div>
            ...
            <div className="flex flex-col items-start gap-3 relative self-stretch w-full flex-[0_0_auto]">
              ...
              <div className="flex flex-wrap items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
                <a
                  ...
                  className="inline-flex min-h-9 md:min-h-10 items-center justify-center gap-2 px-3 md:px-4 py-2 md:py-3 rounded-xl md:rounded-2xl hover:opacity-80 transition-opacity"
                >
                  <span className=" font-extralight text-white text-sm md:text-base tracking-[0] leading-4 whitespace-nowrap">
                    Instagram
                  </span>
          ...
          >
            <span className=" font-extralight text-white text-sm md:text-base text-center tracking-[0] leading-4">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-4 pt-6 md:pt-8 pb-0 px-0 relative self-stretch w-full flex-[0_0_auto] border-t border-white/20">
        <div className="inline-flex flex-col md:flex-row flex-wrap items-start gap-3 md:gap-4 relative flex-[0_0_auto]">
          <p className="inline-flex flex-col items-start relative self-stretch flex-[0_0_auto] opacity-60">
            <span className="text-[#ffffffcc] text-xs md:text-sm lg:text-base leading-4 mt-[-1.00px] font-extralight tracking-[0]">
              {t.footer.copyright}
            </span>
          </p>
